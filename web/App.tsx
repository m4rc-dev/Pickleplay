        ...
        <div className={`${role === 'guest' || isAuthPage
          ...
          <div key={location.pathname} className={isAuthPage ? "" : "animate-route-transition"}>
            <Routes location={location}>
              ...
              <Route path="/news/:articleId/:slug" element={isTwoFactorPending ? <Navigate to="/verify-2fa" replace /> : !feat('news') ? <FeatureUnavailable featureName="news" /> : role === 'guest' ? <div className="p-4 md:p-8 pt-20 md:pt-32 max-w-[1800px] mx-auto w-full"><News /></div> : <News />} />

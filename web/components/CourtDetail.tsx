...
const CourtDetail: React.FC = () => {
    ...
    return (
        <div className="pt-0 md:pt-28 pb-24 md:pb-12 px-4 md:px-12 lg:px-24 max-w-[1920px] mx-auto min-h-screen relative">
            <div className="space-y-4 md:space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-4 md:space-y-8">
                        <div className="bg-white p-4 md:p-12 rounded-3xl md:rounded-[48px] border border-slate-200 shadow-sm space-y-4 md:space-y-8">
                            <div>
                                <p className="text-[10px] md:text-xs font-black text-blue-600 uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-3">COURT DETAILS</p>
                                <h1 className="text-2xl md:text-5xl font-black text-slate-950 tracking-tighter leading-tight mb-3 md:mb-4">{court.name}</h1>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                                <div className="p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-[32px] border border-slate-100">
                                    <p className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-wider md:tracking-widest mb-1 md:mb-2">Price</p>
                                ...
                                <div className="p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-[32px] border border-slate-100">
                                    <p className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-wider md:tracking-widest mb-1 md:mb-2">Capacity</p>
                                    <div className="flex items-baseline gap-1">
                                ...
                                <button
                                    ...
                                    className="p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-[32px] border border-slate-100 hover:border-amber-400 hover:bg-white transition-all text-left group"
                                >
                                    <p className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-wider md:tracking-widest mb-1 md:mb-2 group-hover:text-amber-600">Rating</p>
                                ...
                                <div className="p-4 md:p-6 bg-slate-50 rounded-2xl md:rounded-[32px] border border-slate-100">
                                    <p className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-wider md:tracking-widest mb-1 md:mb-2">Category</p>
                            ...
                            <div className="space-y-2 md:space-y-4">
                                <p className="text-[10px] md:text-xs font-black text-slate-900 uppercase tracking-widest mb-1 md:mb-2">Available Amenities</p>
                            ...
                            {/* Location Info */}
                            <div className="p-4 md:p-8 bg-blue-50 rounded-2xl md:rounded-[32px] border border-blue-100 flex items-start gap-3 md:gap-4">
                    ...
                    <div className="lg:sticky lg:top-32 space-y-4 md:space-y-6">
                        <div className="bg-white p-4 md:p-8 rounded-3xl md:rounded-[40px] border border-slate-200 shadow-xl space-y-4 md:space-y-8">
                            <div>
                                <h3 className="text-lg md:text-xl font-black text-slate-950 tracking-tight mb-1 md:mb-2">Select Schedule</h3>

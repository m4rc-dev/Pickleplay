                                        ...
                                        <tr key={court.id} className="group hover:bg-blue-50/30 transition-colors cursor-pointer"
                                            ...
                                            <td className="px-6 py-5 text-center">
                                                {isOwnerView ? (
                                                    ...
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-300">Owner only</span>
                                                )}
                                            </td>
                                            <td className="px-6 py-5 text-center">
                                            ...
                                            <td className="px-6 py-5 text-right">
                                                <div className="flex items-center justify-end gap-2" onClick={e => e.stopPropagation()}>
                                                    {isOwnerView ? (
                                                        ...
                                                        <>
                                                            <button onClick={() => navigate(bookingsRoute)}
                                                                className="rounded-xl border border-blue-200 px-3 py-2 text-[9px] font-black uppercase tracking-widest text-blue-600 hover:bg-blue-50 transition-all" title="Manage Bookings">
                                                                Bookings
                                                            </button>
                                                            <button onClick={() => navigate(scheduleRoute)}
                                                                className="rounded-xl border border-slate-200 px-3 py-2 text-[9px] font-black uppercase tracking-widest text-slate-600 hover:bg-slate-50 transition-all" title="Manage Schedule">
                                                                Schedule
                                                            </button>
                                                        </>
                                                    )}

...
export const sendGuestBookingEmail = async (data: GuestBookingEmailData): Promise<{ success: boolean; error?: string }> => {
    try {
        ...
        // Full email HTML — matches PicklePlay website color palette (slate-950, blue-600, white)
        const htmlContent = `
<div style="font-family: system-ui, -apple-system, 'Segoe UI', sans-serif; margin: 0; padding: 0; background-color: #f1f5f9;">
  <div style="max-width: 600px; margin: 0 auto;">

    <!-- Header Bar -->
    <div style="background-color: #020617; padding: 28px 32px; text-align: center;">
      <h1 style="margin: 0; font-size: 26px; font-weight: 900; letter-spacing: 2px; color: #ffffff; text-transform: uppercase;">
        🏸 PICKLE<span style="color: #2563eb;">PLAY</span>
      </h1>
      <p style="margin: 6px 0 0; font-size: 11px; color: #94a3b8; letter-spacing: 3px; text-transform: uppercase; font-weight: 600;">Philippines</p>
    </div>
    ...
    <div style="background-color: #ffffff; padding: 36px 32px;">
      ...
      <p style="margin: 0 0 24px; font-size: 14px; color: #64748b; line-height: 1.6;">
        A court has been booked for you at <strong style="color: #0f172a;">${data.locationName}</strong>. Here's your booking receipt:
      </p>
      ...
      <div style="background-color: #f8fafc; border: 2px solid #e2e8f0; border-radius: 16px; padding: 24px; margin-bottom: 28px;">
        <div style="text-align: center; margin-bottom: 18px;">
          <span style="display: inline-block; background-color: #020617; color: #ffffff; font-size: 10px; font-weight: 800; padding: 6px 18px; border-radius: 20px; letter-spacing: 2px; text-transform: uppercase;">Booking Receipt</span>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            ...
            <td style="padding: 11px 0; border-bottom: 1px solid #e2e8f0; color: #0f172a; font-size: 13px; font-weight: 800; text-align: right; font-family: monospace; letter-spacing: 1px;">${data.referenceId.slice(0, 8).toUpperCase()}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding: 14px 0 0; color: #020617; font-size: 15px; font-weight: 900;">TOTAL</td>
            <td style="padding: 14px 0 0; color: #020617; font-size: 22px; font-weight: 900; text-align: right;">${data.totalPrice > 0 ? `₱${data.totalPrice.toFixed(2)}` : 'FREE'}</td>
          </tr>
        </table>
      </div>

      <!-- Setup Account CTA -->
      <div style="background-color: #020617; border-radius: 16px; padding: 28px 24px; text-align: center; margin-bottom: 28px;">
        ...
        <p style="color: #94a3b8; font-size: 13px; line-height: 1.5; margin: 0 0 20px;">
          Set your password for <strong style="color: #60a5fa;">${data.guestEmail}</strong> and this booking will automatically appear in your <strong style="color: #ffffff;">My Bookings</strong> page.
        </p>
        <a href="${signupUrl}" target="_blank" style="display: inline-block; text-decoration: none; color: #ffffff; background-color: #2563eb; padding: 14px 36px; border-radius: 12px; font-size: 14px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase;">
          Setup Your Account
        </a>
        <p style="color: #475569; font-size: 11px; margin: 14px 0 0;">
    ...
    <!-- Bottom Bar -->
    <div style="background-color: #020617; padding: 16px 32px; text-align: center;">
      <p style="margin: 0; font-size: 10px; color: #475569; letter-spacing: 1px;">
        © 2026 PicklePlay Philippines · <a href="https://www.pickleplay.ph" style="color: #475569; text-decoration: none;">pickleplay.ph</a>
      </p>
    </div>
